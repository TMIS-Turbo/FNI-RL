...
This research has been published in [IEEE TPAMI](https://ieeexplore.ieee.org/abstract/document/10273631), and it has also been featured in [IEEE Spectrum](https://spectrum.ieee.org/autonomous-vehicle-safety-defensive-driving) magazine.

## Introduction
### Schematic of the Proposed FNI-RL Framework for Safe Autonomous Driving
<img src="gif/framework.png" alt="ENV" width="600" height="300">
